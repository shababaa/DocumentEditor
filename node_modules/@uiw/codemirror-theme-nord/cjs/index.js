...
exports.nordInit = exports.nordDarkStyle = exports.nord = exports.defaultSettingsNord = void 0;
...
var nordDarkStyle = exports.nordDarkStyle = [{
...
var nordInit = exports.nordInit = function nordInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(nordDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
